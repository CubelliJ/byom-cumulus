...
PLIST_SRC="$ROOT/scripts/com.byom-finsonal.sync.plist"
PLIST_DST="$HOME/Library/LaunchAgents/com.byom-finsonal.sync.plist"
...
launchctl bootout "gui/$(id -u)/com.byom-finsonal.sync" 2>/dev/null || true
launchctl bootstrap "gui/$(id -u)" "$PLIST_DST"
launchctl enable "gui/$(id -u)/com.byom-finsonal.sync"
